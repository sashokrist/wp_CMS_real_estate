...
/**
 * Filter the properties archive via GET params:
 * - s: search term
...
add_action('pre_get_posts', function ($q) {
    ...
    if ($q->is_post_type_archive('property')) {
        ...
        // Numeric meta (stored as strings -> compare as numeric)
        ...
        // Optional: default ordering by date desc (keep WP default). If ordering by price needed:
        // if ($min_price !== '' || $max_price !== '') {
        //     $q->set('meta_key', '_rep_price');
